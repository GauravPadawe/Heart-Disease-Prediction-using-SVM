...
# 
# 
# - Then we'll also vizualize some features to get better idea about dicrete values.
# 
# 
# - Vizualizing Target attribute will shows us if we've imbalanced dataset.
...
# 
# 
# - While, **negative correlation** is observed between **"thalach" and "age"** , i.e, **most of the peoples heartbeat has been found increasing as they age.**
# 
# 
...
# 
# 
# - We can observe that we have most people of **50 to 60 age.**
...
# - Before documentation I had observed that **SVMSMOTE throws error** because the **examples of minority classs are too less to be identified by train-test split.**
# 
# 
...
# 
# 
# - On these **92 examples** we'll perform **SVMSMOTE** and **train a statistical model.** That model will **predict** on this **validation set.**
# 
# 
...
# 
# - As we can observe that its is **not possible to divide these classes by line** because the **class in blue is surrounding class in red** making it non-seperable and so we call it **Non-linearly seperable data.**
# 
# 
# - In SVM we've a function called **Kernel Function / Kernel Trick.** Kernel Trick solves our problem of Non-linearly seperable data. It takes **Low dimensional data** as **input** and **outputs** them in **Higher dimension** so that it can be divided by **hyperplane.** (Refer to figure below)
# 
...
#     - Maximum Iteration : 500 to 100 by difference of 10
